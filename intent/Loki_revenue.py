...
def debugInfo(inputSTR, utterance):
    if DEBUG_revenue:
        print("[revenue] {} ===> {}".format(inputSTR, utterance))

def getResult(inputSTR, utterance, args, resultDICT):
    debugInfo(inputSTR, utterance)
    if utterance == "[台積電][近][一季][營收]":
        # write your code here
        pass

    if utterance == "[台積電]的[近][一季][營收]是多少":
        # write your code here
        pass

    if utterance == "[季][營收][台積電]":
        # write your code here
        pass

    if utterance == "[近][一季][營收][台積電]":
        # write your code here
        pass
